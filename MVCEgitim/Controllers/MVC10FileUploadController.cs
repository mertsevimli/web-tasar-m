...
namespace MVCEgitim.Controllers
{
    public class MVC10FileUploadController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Index(IFormFile? dosya) //* MVC de dosya yükleme IFormFile interface i ile yapılıyor.Burada Dosya isminin ekrandaki file upload namei ile aynı olması gerekir yoksa dosya yüklenmez.!
        {
            if (dosya is not null)
            {
                ...
                if (uzanti == ".jpg" || uzanti == ".jpeg" || uzanti == ".png" || uzanti == ".gif") // Sadece bu uzantılardaki dosyaları kabul et
                {
                    ...
                    TempData["message"] =
                        "Sadece .jpg, .jpeg, .png, .gif Resimleri Yükleyebilirsiniz! ";
            }
            return View();
        }
        [HttpPost]
